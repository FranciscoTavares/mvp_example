...
class OpenFragment : Fragment() {
    ...
    private var presenter: OpenSchedulePresenter? = null
    ...
    private fun initListeners() {
        presenter = OpenSchedulePresenter
...
//        }
        ...
        presenter?.setStateEmpty = { isEmpty ->
            if (isEmpty) {
                ...
                placeholder.text = context?.getString(R.string.open_fragment_placeholder)
    ...
    private fun updateScheduleList() {
        adapter?.replaceAll(presenter?.getAllOpenScedule() ?: ArrayList())
    }
}
